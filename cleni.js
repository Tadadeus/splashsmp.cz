...
const cleni = [
  ...
  { section: "hrac", name: "bratranec", skin: "Bratranec", role: "Hráč", roleClass: "role--gray", desc: "Prezident season 5", quote: "Posunu SplashSMP dál.", longDesc: "Bratranec se stal prezidentem v season 5. Někteří říkají, že mu to vlezlo do hlavy, ovšem pravda je, že se snaží dostat SplashSMP ještě výš, než kam ho dotáhla úspěšná vláda Tadadeuse. Je také členem tajné organizace KyS, o které se nesmí mluvit." },
  { section: "hrac", name: "TakyOndatra", role: "Hráč", roleClass: "role--gray", desc: "Předseda vlády", quote: "Vše mám pod kontrolou.", longDesc: "Někteří TakyOndatru považují za nekompetentního předsedu vlády, jeho činy ale mluví za vše. Při předvolební debatě byl údajně pod vlivem omamných a psychotropních látek, které měl získat od jistého distributora ze Šindlovy base." },
  ...
  { section: "hrac", name: "Screenatyouruse", role: "Hráč", roleClass: "role--gray", desc: "Člen teroristického teamu GNMT", quote: "Autority jsou tu od toho, aby padaly.", longDesc: "Screeny je člen teroristického teamu GNMT. Nebojí se odporovat autoritám, sám by ale ve vedení neuspěl. Vztek si vylévá na hráče SindlSin, který poté trucuje v /jail." },
  ...
  { section: "hrac", name: "Pokkyy07", role: "Hráč", roleClass: "role--gray", desc: "Hráč ze 4. sezony", quote: "Base nejlíp ve dvou.", longDesc: "Pokkyy07 je na serveru od čtvrté sezony a má společnou base s Krystofem200816. Společně tvoří sehranou dvojku." },
  ...
  { section: "hrac", name: "TytaCZ", role: "Hráč", roleClass: "role--gray", desc: "Stavitel a fanoušek kvantové fyziky", quote: "Postavím to a ještě ti vysvětlím kvantovku.", longDesc: "TytaCZ rád staví a má slabost pro kvantovou fyziku. Na serveru je už od čtvrté sezony a patří k pevné části komunity." },
  ...
  { section: "hrac", name: "Krystof200816", role: "Hráč", roleClass: "role--gray", desc: "Hráč ze 4. sezony", quote: "Base nejlíp ve dvou.", longDesc: "Krystof200816 je na serveru od čtvrté sezony a má společnou base s Pokkyy07. Společně tvoří sehranou dvojku." },
  ...
  { section: "hrac", name: "4Rampagerss", role: "Hráč", roleClass: "role--gray", desc: "OG hráč, takzvaná známá firma", quote: "Prachů mám dost.", longDesc: "4Rampagerss je OG hráč, takzvaná známá firma. Měl na spawnu vlastní shop a ve třetí sezoně mu místo něj Pastel world editem postavil radnici. Je také pěkně zazobaný, peněz má víc než dost." },
  ...
  { section: "hrac", name: "RileLevakus", role: "Hráč", roleClass: "role--gray", desc: "Hráč ze starších sezón", quote: "Měl jsem práva, co jsem mít neměl.", longDesc: "RileLevakus je na serveru zhruba od třetí sezony. Zneužíval práva, která získal zapovězeným způsobem – měl vanish, teleport i příkaz na zjištění pozice hráčů a jejich base." },
