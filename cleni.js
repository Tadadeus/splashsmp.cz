...
const cleni = [
  ...
  { section: "hrac", name: "Ludeng", skin: "Ludeng69", role: "Hráč", roleClass: "role--gray", desc: "Doktor a hlavní alchymista serveru", quote: "Mám lektvar na všechno a pěněz víc než ty.", longDesc: "Ludeng zastává roli Doktora a je hlavním alchymistou serveru. Vyrábí a distribuuje léčivé i posilující lektvary a je nepostradatelný v každém PvP souboji i expedici. Jeho specializací je také výzkum nových lektvarů a jejich efektů – je to velmi cenný a klidný člen týmu. Jo a taky abych nezapomněl..., je to zazobanej židoarda." },
  ...
  { section: "hrac", name: "4Rampagerss", role: "Hráč", roleClass: "role--gray", desc: "OG hráč, takzvaná známá firma", quote: "Prachů mám dost.", longDesc: "4Rampagerss je OG hráč, takzvaná známá firma. Měl na spawnu vlastní shop a ve třetí sezóně mu místo něj někdo pastel world editem radnici. Je také pěkně zazobaný, peněz má víc než dost." },
