...
window.CLENI = [
  ...
  { section: "hrac", name: "Kripi33", lore: true, role: "Hráč", roleClass: "role--gray", desc: "OG hráč (season 1–4)", quote: "Vyhrál jsem volby, postavil traphouse.", longDesc: "Kripi33 je OG hráč SplashSMP, pravděpodobně už od season 1 až 4. V první sezóně vyhrál 3. volby prezidenta a v sezóně 4 si postavil pověstný traphouse. Patří mezi staré známé tváře serveru.", hist: "ev-kripi" },
  { section: "hrac", name: "Gingo13", lore: true, role: "Hráč", roleClass: "role--gray", desc: "Největší magor v historii serveru", quote: "Chlochtan degeneruje...", longDesc: "Gingo byl největší magor, co kdy SplashSMP zažilo. Měl svůj shop až za spawnem, protože nikdo nechtěl, aby byl na spawnu. Byl zneužíván, spawnkillován a trollen hráči i adminy – a ve voicechatu zněl jako Chlochtan." },
  { section: "hrac", name: "Paldes12", lore: true, role: "Hráč", roleClass: "role--gray", desc: "Záhadný člen skupiny Shadow Mafia", quote: "Pohybuji se ve stínu.", longDesc: "Paldes byl člověk, o kterém nikdo neví, kdo ho na server nabral a jak vůbec prošel náborem. Po serveru se pohyboval potají a ve stínu, schovaný za jménem „Shadow Mafia\" – skupinou, kterou tvořilo několik dalších hráčů. Jejich cílem bylo zabránit Adasovi v cestě k moci, to se jim ale podařilo jen částečně: vyhrála strana Tadadeuse a premiérem se stal Adas. Adas poté využíval toho, že se jeho svržení nikdy nepodařilo, a Shadow Mafii zastrašila armáda politické strany ARDA.", hist: "ev-paldes" },
